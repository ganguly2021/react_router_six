      ...
      <div className="modal-dialog" role="document">
        <div className="modal-content rounded-5 shadow">
          <div className="modal-header p-5 pb-4 border-bottom-0">
            ...
            <h2 className="fw-bold mb-0">Signup Here</h2>
          ...
          <div className="modal-body p-5 pt-0">
            <form onSubmit={handleFormSubmit}>
              ...
              <button className="w-100 mb-2 btn btn-lg rounded-4 btn-primary" type="submit">Signup</button>
              <small className="text-muted">By clicking signing up, you agree to the terms of use.</small>
              <hr className="my-4" />
